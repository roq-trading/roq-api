...
struct MarketByOrderUpdate FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyField<uint16_t>(verifier, VT_STREAM_ID) &&
           ...
           VerifyField<int64_t>(verifier, VT_EXCHANGE_SEQUENCE) && verifier.EndTable();
  }
};
...
inline flatbuffers::Offset<MarketByOrderUpdate> CreateMarketByOrderUpdateDirect(
  ...
  return roq::fbs::CreateMarketByOrderUpdate(
      _fbb, stream_id, exchange__, symbol__, bids__, asks__, update_type, exchange_time_utc, exchange_sequence);
}
...
struct Event FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const roq::fbs::CustomMetricsUpdate *message_as_CustomMetricsUpdate() const {
    return message_type() == roq::fbs::Message_CustomMetricsUpdate
               ? static_cast<const roq::fbs::CustomMetricsUpdate *>(message())
               : nullptr;
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
...
template <>
inline const roq::fbs::CustomMetricsUpdate *Event::message_as<roq::fbs::CustomMetricsUpdate>() const {
