...
inline const char *EnumNameConnectionStatus(ConnectionStatus e) {
  if (flatbuffers::IsOutRange(e, ConnectionStatus::Undefined, ConnectionStatus::Connected)) return "";
...
inline const char *EnumNameError(Error e) {
  if (flatbuffers::IsOutRange(e, Error::Undefined, Error::ExecutionInstructionNotSupported)) return "";
  const size_t index = static_cast<size_t>(e);
...
inline const char *EnumNameGatewayStatus(GatewayStatus e) {
  if (flatbuffers::IsOutRange(e, GatewayStatus::Undefined, GatewayStatus::LoggedOut)) return "";
  const size_t index = static_cast<size_t>(e);
...
inline const char *EnumNameOrderStatus(OrderStatus e) {
  if (flatbuffers::IsOutRange(e, OrderStatus::Undefined, OrderStatus::Canceled)) return "";
  const size_t index = static_cast<size_t>(e);
...
inline const char *EnumNameRequestStatus(RequestStatus e) {
  if (flatbuffers::IsOutRange(e, RequestStatus::Undefined, RequestStatus::Timeout)) return "";
  const size_t index = static_cast<size_t>(e);
...
inline const char *EnumNameSecurityType(SecurityType e) {
  if (flatbuffers::IsOutRange(e, SecurityType::Undefined, SecurityType::Option)) return "";
  const size_t index = static_cast<size_t>(e);
...
inline const char *EnumNameStatisticsType(StatisticsType e) {
  if (flatbuffers::IsOutRange(e, StatisticsType::Undefined, StatisticsType::MarginRate)) return "";
  const size_t index = static_cast<size_t>(e);
...
inline const char *EnumNameTimeInForce(TimeInForce e) {
  if (flatbuffers::IsOutRange(e, TimeInForce::Undefined, TimeInForce::GTC)) return "";
  const size_t index = static_cast<size_t>(e);
...
inline const char *EnumNameTradingStatus(TradingStatus e) {
  if (flatbuffers::IsOutRange(e, TradingStatus::Undefined, TradingStatus::Open)) return "";
  const size_t index = static_cast<size_t>(e);
...
inline const char *EnumNameMessage(Message e) {
  if (flatbuffers::IsOutRange(e, Message::NONE, Message::FundsUpdate)) return "";
  const size_t index = static_cast<size_t>(e);
...
template<> struct MessageTraits<roq::fbs::MarketDataStatus> {
  static const Message enum_value = Message::MarketDataStatus;
};

template<> struct MessageTraits<roq::fbs::OrderManagerStatus> {
...
struct Fill FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  uint32_t trade_id() const {
    return GetField<uint32_t>(VT_TRADE_ID, 0);
  }
  uint32_t gateway_trade_id() const {
    return GetField<uint32_t>(VT_GATEWAY_TRADE_ID, 0);
  }
...
struct Layer FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<double>(verifier, VT_BID_PRICE) &&
           VerifyField<double>(verifier, VT_BID_QUANTITY) &&
           VerifyField<double>(verifier, VT_ASK_PRICE) &&
           VerifyField<double>(verifier, VT_ASK_QUANTITY) &&
           verifier.EndTable();
  }
};
...
inline flatbuffers::Offset<CreateOrder> CreateCreateOrder(
    ...
    roq::fbs::ExecutionInstruction execution_instruction = roq::fbs::ExecutionInstruction::Undefined,
...
struct DownloadEnd FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, VT_ACCOUNT) &&
           verifier.VerifyString(account()) &&
           VerifyField<uint32_t>(verifier, VT_MAX_ORDER_ID) &&
           verifier.EndTable();
  }
};
...
struct ExternalLatency FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<int64_t>(verifier, VT_LATENCY) &&
           verifier.EndTable();
  }
};
...
struct FundsUpdate FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<double>(verifier, VT_BALANCE) &&
           VerifyField<double>(verifier, VT_HOLD) &&
...
struct MarketByOrderUpdate FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool snapshot() const {
    return GetField<uint8_t>(VT_SNAPSHOT, 0) != 0;
  }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<int64_t>(verifier, VT_EXCHANGE_TIME_UTC) &&
           verifier.EndTable();
  }
};
...
struct MarketDataStatusBuilder {
  ...
  explicit MarketDataStatusBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
struct MarketStatus FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_SYMBOL) &&
           verifier.VerifyString(symbol()) &&
           VerifyField<uint8_t>(verifier, VT_TRADING_STATUS) &&
           verifier.EndTable();
  }
};
...
struct OrderAck FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  uint32_t gateway_order_id() const {
    return GetField<uint32_t>(VT_GATEWAY_ORDER_ID, 0);
  }
  const flatbuffers::String *external_account() const {
    return GetPointer<const flatbuffers::String *>(VT_EXTERNAL_ACCOUNT);
  }
...
struct OrderManagerStatusBuilder {
  ...
  explicit OrderManagerStatusBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
inline flatbuffers::Offset<OrderManagerStatus> CreateOrderManagerStatusDirect(
    ...
    roq::fbs::GatewayStatus status = roq::fbs::GatewayStatus::Undefined) {
  auto account__ = account ? _fbb.CreateString(account) : 0;
  return roq::fbs::CreateOrderManagerStatus(
      _fbb,
      account__,
      status);
}
...
struct PositionUpdate FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  uint32_t last_trade_id() const {
    return GetField<uint32_t>(VT_LAST_TRADE_ID, 0);
  }
...
struct PositionUpdateBuilder {
  ...
  void add_position_yesterday(double position_yesterday) {
    fbb_.AddElement<double>(PositionUpdate::VT_POSITION_YESTERDAY, position_yesterday, std::numeric_limits<double>::quiet_NaN());
  }
  void add_position_cost_yesterday(double position_cost_yesterday) {
    fbb_.AddElement<double>(PositionUpdate::VT_POSITION_COST_YESTERDAY, position_cost_yesterday, std::numeric_limits<double>::quiet_NaN());
  }
  void add_external_account(flatbuffers::Offset<flatbuffers::String> external_account) {
...
struct ReferenceData FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<int64_t>(verifier, VT_EXPIRY_DATETIME_UTC) &&
           verifier.EndTable();
  }
};
...
struct HandshakeAck FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           verifier.VerifyString(hostname()) &&
           VerifyField<uint32_t>(verifier, VT_PID) &&
           VerifyField<uint8_t>(verifier, VT_FAILURE) &&
           ...
           VerifyOffset(verifier, VT_NAME) &&
           verifier.VerifyString(name()) &&
           VerifyField<uint8_t>(verifier, VT_USER_ID) &&
           verifier.EndTable();
  }
};
...
struct SourceInfo FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint64_t>(verifier, VT_SEQNO) &&
...
struct Event FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const roq::fbs::MarketDataStatus *message_as_MarketDataStatus() const {
    return message_type() == roq::fbs::Message::MarketDataStatus ? static_cast<const roq::fbs::MarketDataStatus *>(message()) : nullptr;
  }
  const roq::fbs::OrderManagerStatus *message_as_OrderManagerStatus() const {
    return message_type() == roq::fbs::Message::OrderManagerStatus ? static_cast<const roq::fbs::OrderManagerStatus *>(message()) : nullptr;
  }
...
template<> inline const roq::fbs::MarketDataStatus *Event::message_as<roq::fbs::MarketDataStatus>() const {
  return message_as_MarketDataStatus();
}

template<> inline const roq::fbs::OrderManagerStatus *Event::message_as<roq::fbs::OrderManagerStatus>() const {
