...
struct ROQ_PACKED OrderUpdateAction final {
  ...
  explicit constexpr OrderUpdateAction(uint8_t value) : type_(validate(value)) {}

  explicit constexpr OrderUpdateAction(const std::string_view &value) : type_(validate(value)) {}
