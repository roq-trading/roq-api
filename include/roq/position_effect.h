...
struct ROQ_PACKED PositionEffect final {
  ...
  explicit constexpr PositionEffect(uint8_t value) : type_(validate(value)) {}

  explicit constexpr PositionEffect(const std::string_view &value) : type_(validate(value)) {}
