...
TEST(safe_cast, int_to_int) {
  ...
  // ... overflow
  EXPECT_THROW((void)static_cast<int16_t>(safe_cast<int32_t>(-32769)), OverflowError);
  EXPECT_THROW((void)static_cast<int16_t>(safe_cast<int32_t>(32768)), OverflowError);
  // int16_t --> int32_t
...
TEST(safe_cast, float_to_int) {
  ...
  // 9223372036854775807);
  // ... overflow
  EXPECT_THROW((void)static_cast<int64_t>(safe_cast<double>(-9223372036854775808.0)), OverflowError);
  EXPECT_THROW((void)static_cast<int64_t>(safe_cast<double>(9223372036854775808.0)), OverflowError);
  // have seen this
